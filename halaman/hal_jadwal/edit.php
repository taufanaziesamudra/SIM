						...
						<div>
									...
									<div class="form-group">
										...
										<div>
											<select name="id_mesin" id="id_mesin" class="form-control">
												...
												foreach (mesin(['id_divisi'=>$r->id_divisi]) as $m) {
							...
							<div class="row">
								<div class="col-xs-8 col-sm-6">
									<div class="radio">
										<label>
											<input name="point_chek" type="radio" class="ace" value="Filter Oil" <?=$r->point_chek == 'Filter Oil' ? 'checked' : '' ?>/>
											<span class="lbl"> Filter Oil</span>
										</label>
									</div>
									<div class="radio">
										<label>
											<input name="point_chek" type="radio" class="ace" value="Filter Pelumas" <?=$r->point_chek == 'Filter Pelumas' ? 'checked' : '' ?>/>
											<span class="lbl"> Filter Pelumas</span>
										</label>
									</div>
									<div class="radio">
										<label>
											<input name="point_chek" type="radio" class="ace" value="Oil Coller" <?=$r->point_chek == 'Oil Coller' ? 'checked' : '' ?>/>
											<span class="lbl"> Oil Coller</span>
										</label>
									</div>
									<div class="radio">
										<label>
											<input name="point_chek" type="radio" class="ace" value="Pembersih Stainer" <?=$r->point_chek == 'Pembersih Stainer' ? 'checked' : '' ?>/>
